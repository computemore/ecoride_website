  ...
  <PublicLayout pageKey="ride">
    <section className="mx-auto max-w-content-wide px-4 pb-12 pt-20 md:px-6 md:pt-24 lg:px-8">
      <div className="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
        <div className="text-center lg:text-left">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/76 lg:max-w-3xl">
    ...
    <section className="mx-auto max-w-content-wide px-4 pb-24 md:px-6 lg:px-8">
      <div className="surface-card rounded-card grid gap-6 p-6 md:grid-cols-[1fr,auto] md:items-center md:p-8">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/68">Ready to ride</p>
          <h2 className="mt-3 text-3xl font-semibold text-white">Use the rider app built for clearer local journeys</h2>
